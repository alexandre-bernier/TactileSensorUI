...
void MainWindow::refreshPortsAutoconnect(bool allowAutoconnect)
{
    ...
    foreach (const QSerialPortInfo &info, QSerialPortInfo::availablePorts())
    {
        ...
        // Note: for some strange reason, on windows the description is not the updated Tactile Sensor
        if (info.description() == "Tactile Sensor" || info.description() == "Cypress USB UART")
        {
